package be.technifutur.java2020.GestionStage.Vues;

public class VueMenuFonctionnalite {
    ...
    public void afficherMenuFonctionnalite() {
        ...
        System.out.println("4 - SELECTIONNER UN STAGE");
        System.out.println("5 - AFFICHER LA LISTE DES STAGES");
        System.out.println("\n");
